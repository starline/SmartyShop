...
class HelpCommand extends UserCommand
{
     ...
     * @var string
     */
    protected $description = 'Показать все команды';
    ...
    public function execute(): ServerResponse
    {
        ...
        return $this->replyToChat('`/' . $command_str . '` такая команда не найдена', ['parse_mode' => 'markdown']);
    }
